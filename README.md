...
- Premium background removal via on-device background removal (remove.bg no longer required in the current build)
...
- `REMOVEBG_API_KEY (optional legacy key, not required in the current on-device background-removal build)`
